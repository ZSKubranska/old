function UnityProgress (dom) {
	...
	link.href = 'http://1000webgames.com/in2.php?id=1&gname=m_acceleration_webgl&lplace=loading&refe=' + ref;
	link.target = "_blank";
	...
	this.Update = function() {
		...
		this.logoImage.style.top = 50 + '%';
		this.logoImage.style.left = 50 + '%';
		this.logoImage.style.marginLeft = -300 + 'px';
		this.logoImage.style.marginTop = -80 + 'px'
		this.logoImage.style.width = logoImg.width+'px';
		this.logoImage.style.height = logoImg.height+'px';

		this.progressFrame.style.top = this.dom.offsetTop + (this.dom.offsetHeight * 0.8 + logoImg.height * 0.5 + 10) + 'px';
